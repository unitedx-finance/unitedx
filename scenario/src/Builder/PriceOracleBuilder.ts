...
export async function buildPriceOracle(
  ...
  world = await storeAndSaveContract(world, priceOracle, 'PriceOracle', invokation, [{ index: ['PriceOracle'], data: priceOracleData }]);
...
export async function setPriceOracle(
  ...
  world = await storeAndSaveContract(world, priceOracle, 'PriceOracle', null, [{ index: ['PriceOracle'], data: priceOracleData }]);
