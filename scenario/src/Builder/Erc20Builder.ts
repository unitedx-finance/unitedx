...
export async function buildErc20(world: World, from: string, event: Event): Promise<{ world: World; erc20: Erc20; tokenData: TokenData }> {
  const fetchers = [
    new Fetcher<{ symbol: StringV; address: AddressV; name: StringV }, TokenData>(
      ...
      `,
      'Existing',
      [new Arg('symbol', getStringV), new Arg('address', getAddressV), new Arg('name', getStringV, { default: undefined })],
    ...
    new Fetcher<{ symbol: StringV; name: StringV; decimals: NumberV }, TokenData>(
      ...
      `,
      'NonStandard',
      [new Arg('symbol', getStringV), new Arg('name', getStringV), new Arg('decimals', getNumberV, { default: new NumberV(18) })],
  ...
  world = await storeAndSaveContract(world, erc20, tokenData.symbol, invokation, [
