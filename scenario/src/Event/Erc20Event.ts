...
async function approve(world: World, from: string, erc20: Erc20, address: string, amount: NumberV): Promise<World> {
  ...
  world = addAction(world, `Approved ${erc20.name} ERC-20 token for ${from} of ${amount.show()}`, invokation);
...
async function faucet(world: World, from: string, erc20: Erc20, address: string, amount: NumberV): Promise<World> {
  ...
  world = addAction(world, `Fauceted ${amount.show()} ERC-20 tokens to ${address}`, invokation);
...
async function transfer(world: World, from: string, erc20: Erc20, address: string, amount: NumberV): Promise<World> {
  ...
  world = addAction(world, `Transferred ${amount.show()} ERC-20 tokens from ${from} to ${address}`, invokation);
...
async function transferFrom(world: World, from: string, erc20: Erc20, owner: string, spender: string, amount: NumberV): Promise<World> {
  ...
  world = addAction(world, `"Transferred from" ${amount.show()} ERC-20 tokens from ${owner} to ${spender}`, invokation);
...
async function setPaused(world: World, from: string, erc20: Erc20, pause: boolean): Promise<World> {
  ...
  world = addAction(world, `Set ${erc20.name} ${pause ? 'paused' : 'unpaused'}`, invokation);
...
async function setFee(world: World, from: string, erc20: Erc20, basisPointFee: NumberV, maxFee: NumberV): Promise<World> {
  ...
  world = addAction(world, `Set fee on ${erc20.name} to ${basisPointFee} with a max of ${maxFee}`, invokation);
...
export function erc20Commands() {
  return [
    ...
    new Command<{ erc20: Erc20; spender: AddressV; amount: NumberV }>(
      ...
      `,
      'Approve',
      [new Arg('erc20', getErc20V), new Arg('spender', getAddressV), new Arg('amount', getNumberV)],
    ...
    new Command<{ erc20: Erc20; recipient: AddressV; amount: NumberV }>(
      ...
      `,
      'Faucet',
      [new Arg('erc20', getErc20V), new Arg('recipient', getAddressV), new Arg('amount', getNumberV)],
    ...
    new Command<{ erc20: Erc20; owner: AddressV; spender: AddressV; amount: NumberV }>(
      ...
      `,
      'TransferFrom',
      [new Arg('erc20', getErc20V), new Arg('owner', getAddressV), new Arg('spender', getAddressV), new Arg('amount', getNumberV)],
    ...
    new Command<{ erc20: Erc20; paused: BoolV }>(
      ...
      `,
      'Pause',
      [new Arg('erc20', getErc20V), new Arg('paused', getBoolV, { default: new BoolV(true) })],
    ...
    new Command<{ erc20: Erc20; basisPointFee: NumberV; maxFee: NumberV }>(
      ...
      `,
      'SetFee',
      [new Arg('erc20', getErc20V), new Arg('basisPointFee', getNumberV), new Arg('maxFee', getNumberV)],
