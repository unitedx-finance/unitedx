...
export function compFetchers() {
  return [
    ...
    new Fetcher<{ comp: Comp; address: AddressV }, NumberV>(
      ...
      `,
      'TokenBalance',
      [new Arg('comp', getComp, { implicit: true }), new Arg('address', getAddressV)],
    ...
    new Fetcher<{ comp: Comp; owner: AddressV; spender: AddressV }, NumberV>(
      ...
      `,
      'Allowance',
      [new Arg('comp', getComp, { implicit: true }), new Arg('owner', getAddressV), new Arg('spender', getAddressV)],
    ...
    new Fetcher<{ comp: Comp; account: AddressV; blockNumber: NumberV }, NumberV>(
      ...
      `,
      'GetPriorVotes',
      [new Arg('comp', getComp, { implicit: true }), new Arg('account', getAddressV), new Arg('blockNumber', getNumberV)],
      async (world, { comp, account, blockNumber }) =>
        new NumberV(await comp.methods.getPriorVotes(account.val, blockNumber.encode()).call())
    ),
