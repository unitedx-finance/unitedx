...
export function mcdFetchers() {
  return [
    new Fetcher<{ potAddress: AddressV; method: StringV; args: StringV[] }, Value>(
      ...
      `,
      'PotAt',
      [new Arg('potAddress', getAddressV), new Arg('method', getStringV), new Arg('args', getCoreValue, { variadic: true, mapped: true })],
    ...
    new Fetcher<{ vatAddress: AddressV; method: StringV; args: StringV[] }, Value>(
      ...
      `,
      'VatAt',
      [new Arg('vatAddress', getAddressV), new Arg('method', getStringV), new Arg('args', getCoreValue, { variadic: true, mapped: true })],
