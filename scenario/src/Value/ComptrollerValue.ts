...
import { getAddressV, getCoreValue, getStringV, getNumberV } from '../CoreValue';
...
export async function getHypotheticalLiquidity(
  ...
  let { 0: error, 1: liquidity, 2: shortfall } = await comptroller.methods
...
export function comptrollerFetchers() {
  return [
    ...
    new Fetcher<{ comptroller: Comptroller; account: AddressV; cToken: CToken }, BoolV>(
      ...
      `,
      'CheckMembership',
      [new Arg('comptroller', getComptroller, { implicit: true }), new Arg('account', getAddressV), new Arg('cToken', getCTokenV)],
    ...
    new Fetcher<{ comptroller: Comptroller; CToken: CToken; key: StringV }, NumberV>(
      ...
      `,
      'CompSupplyState',
      [new Arg('comptroller', getComptroller, { implicit: true }), new Arg('CToken', getCTokenV), new Arg('key', getStringV)],
    ...
    new Fetcher<{ comptroller: Comptroller; CToken: CToken; account: AddressV }, NumberV>(
      ...
      `,
      'CompSupplierIndex',
      [new Arg('comptroller', getComptroller, { implicit: true }), new Arg('CToken', getCTokenV), new Arg('account', getAddressV)],
